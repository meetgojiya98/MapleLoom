...
REST API
to check the state of the consensus.
Sharding
...
Replication factor
When you create a collection, you can control how many shard replicas you’d like to store by changing the
replication_factor
. By default,
replication_factor
